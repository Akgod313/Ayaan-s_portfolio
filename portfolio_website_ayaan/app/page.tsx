        ...
        <div className="h-[400vh] w-full relative z-40">
          <div className="sticky top-0 h-screen w-full flex items-center justify-center overflow-hidden bg-[#111317]">
            ...
            >
              <div className="flex flex-col items-center md:items-start text-center md:text-left flex-1">
                <h2 className="text-5xl md:text-6xl lg:text-7xl font-extrabold text-white tracking-tight mb-4 drop-shadow-[0_0_15px_rgba(255,255,255,0.1)]">
                  "I build real, working apps. From Firebase-backed trackers to full-stack tools — solo, from scratch."
                </h2>
              ...
              <div className="relative w-full md:w-[450px] h-[250px] md:h-[300px] rounded-2xl overflow-hidden shadow-[0_0_30px_rgba(0,229,255,0.15)] border border-[#00E5FF]/20 flex-shrink-0">
                ...
                <Image src="/Code_editor.png" alt="Coding" fill className="object-cover opacity-60 mix-blend-luminosity hover:mix-blend-normal transition-all duration-500" />
              </div>
            </div>
            ...
            >
              <div className="flex flex-col items-center md:items-start text-center md:text-left flex-1">
                <h2 className="text-5xl md:text-6xl lg:text-7xl font-extrabold text-white tracking-tight mb-4 drop-shadow-[0_0_15px_rgba(255,255,255,0.1)]">
                  "I craft cinematic reels, shorts, and montages — turning raw footage into stories that actually hit."
                </h2>
                <p className="text-[#00E5FF] animate-pulse font-medium tracking-widest uppercase text-sm">Keep scrolling</p>
              </div>
              <div className="relative w-full md:w-[450px] h-[250px] md:h-[300px] rounded-2xl overflow-hidden shadow-[0_0_30px_rgba(0,229,255,0.15)] border border-[#00E5FF]/20 flex-shrink-0">
                <div className="absolute inset-0 bg-black/60 opacity-0 hover:opacity-100 transition-opacity duration-500 flex items-center justify-center z-10">
                  <p className="text-white font-bold tracking-widest text-sm drop-shadow-[0_0_8px_rgba(0,0,0,0.8)]">Video Editing</p>
                </div>
                <Image src="/Video_Timeline.png" alt="Video Editing" fill className="object-cover opacity-80 mix-blend-luminosity hover:mix-blend-normal transition-all duration-500" />
              </div>
            </div>
            ...
            >
              <h2 className="text-4xl md:text-6xl font-extrabold text-white text-center tracking-tight mb-8 drop-shadow-[0_0_15px_rgba(255,255,255,0.1)]">
                "15 years old. Two skills. Endless projects."
              </h2>
        ...
        <section id="projects" className="w-full max-w-5xl mb-32 scroll-mt-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {PROJECTS.map((project) => (
              <div key={project.id} className="group relative bg-[#1E2128] border border-white/5 rounded-2xl overflow-hidden hover:-translate-y-2 transition-all duration-300 hover:shadow-[0_10px_30px_rgba(0,229,255,0.15)] hover:border-[#00E5FF]/40 flex flex-col h-[350px]">
                ...
                <div className="p-6 flex-1 flex flex-col justify-between">
                  <div>
                    <h3 className="text-xl font-bold text-white mb-2 group-hover:text-[#00E5FF] group-hover:drop-shadow-[0_0_8px_rgba(0,229,255,0.6)] transition-all">{project.title}</h3>
                    <p className="text-sm text-gray-400 line-clamp-2" title={project.description}>
                      {project.description}
                    </p>
                  </div>
                  <div className="mt-4 flex gap-3 text-xs font-semibold text-[#00E5FF]">
                    <a href={project.demoLink} target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors cursor-pointer z-10 relative">Demo &rarr;</a>
                    <a href={project.githubLink} target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors cursor-pointer z-10 relative">GitHub &rarr;</a>
                  </div>
                </div>
              </div>
            ))}
